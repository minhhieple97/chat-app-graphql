...
export type SearchUsersQuery = { __typename?: 'Query', searchUsers: { __typename?: 'UsersResponse', total: number, success: boolean, users: Array<{ __typename?: 'User', id?: number | null, fullname: string, email: string, avatarUrl?: string | null, createdAt: any }> } };
